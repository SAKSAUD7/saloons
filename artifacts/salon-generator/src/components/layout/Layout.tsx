...
import { Menu, X, Instagram, Facebook, Twitter, MapPin, Phone, Mail, Clock, Send, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground font-sans">
      ...
      {data && (
        <Link
          href="/generator"
          className="fixed bottom-6 left-6 z-50 flex items-center gap-2 bg-background/90 backdrop-blur-md border border-primary/40 text-primary px-4 py-2.5 rounded-full text-xs uppercase tracking-widest font-semibold shadow-[0_0_20px_rgba(0,0,0,0.4)] hover:bg-primary hover:text-black transition-all duration-300 group"
        >
